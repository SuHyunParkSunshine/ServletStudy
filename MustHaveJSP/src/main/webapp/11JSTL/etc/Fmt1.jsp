...
<body>
	...
	콤마 O(세칸) :	<fmt:formatNumber value="${ number1 }" /><br /> 
	콤마 O(네칸) :	<fmt:formatNumber value="${ number1 }" pattern="0,0000" /><br /> 
	...
	소수점까지 :${ printNum3 }<br />
	<fmt:parseNumber value="${ number2 }" integerOnly="true" var="pringNum4" />
	정수부분만 : ${ pringNum4 }
</body>
</html>