...
<body>
	...
	public String useImplicitObject() {
		return this.getServletContext().getRealPath("/02ImplicitObject"); //this = servlet 뭐시기
	}
	public String useImplicitObject(ServletContext app) { //application = this.getServletContext()
